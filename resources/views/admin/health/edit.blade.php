      ...
      <div class="col-lg-12">
        <div class="card bg-light">
          ...
          <div class="card-body">
            <div class="row" >
              <div class="col-lg-2">
                <img class="card-img-top" src="{{secure_asset('/uploads/avatars/'.$kesehatan->siswa->avatar)}}" alt="Card image">
              </div>
                ...
                <table class="table table-striped" style="width:100%">
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        {{$kesehatan->siswa->nama}}<br>
                        {{$kesehatan->siswa->tmp_lahir}}<br>
                        {{date("d-m-Y", strtotime($kesehatan->siswa->tgl_lahir))}}<br>
                        {{$kesehatan->siswa->jns_kelamin}}<br>
                        {{$umur ?? ""}}
                      </td>
                    </tr>
                  </tbody>
      ...
      <div class="col-lg-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{route('kesehatan.proses2',$kesehatan->id)}}" method="POST">
              @csrf
              @if (isset($awal))
              <div class="form-group">
                <label>Tanggal Pengukuran (mm/dd/yyyy)</label>
                <input type="date" name="tgl_pengukuran" placeholder="Masukan Nama Lengkap" class="form-control" value="{{$awal->tgl_pengukuran}}" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Tanggal Pengukuran (mm/dd/yyyy)</label>
                <input type="date" name="tgl_pengukuran" placeholder="Masukan Nama Lengkap" class="form-control" value="{{$kesehatan->tgl_pengukuran}}" required>
              </div>
              <div class="form-group">
                <label>Kebersihan Kuku</label>
                <select name="k_kuku" class="custom-select">
                  @if ($kesehatan->k_kuku=="Panjang")
                  <option selected value="Panjang">Panjang</option>
                  <option value="Pendek">Pendek</option>
                  @else
                  <option value="Panjang">Panjang</option>
              ...
              <div class="form-group">
                <label>Kebersihan Rambut</label>
                <select name="k_rambut" class="custom-select">
                  @if ($kesehatan->k_rambut=="Panjang")
                  <option selected value="Panjang">Panjang</option>
                  <option value="Sedang">Sedang</option>
                  <option value="Pendek">Pendek</option>
                  @elseif($kesehatan->k_rambut=="Sedang")
                  <option value="Panjang">Panjang</option>
                  <option selected value="Sedang">Sedang</option>
                  <option value="Pendek">Pendek</option>
                  @else
              ...
              <div class="form-group">
                <label>Kebersihan Kulit</label>
                <select name="k_kulit" class="custom-select">
                  @if (strcmp($kesehatan->k_kulit,"Bersih"))
                  <option selected value="1">Bersih</option>
                  <option value="2">Tidak Ada Bercak</option>
                  <option value="3">Tidak Ada Luka Loreng</option>
                  <option value="4">Terdapat Bercak</option>
                  <option value="5">Luka Koreng</option>
                  <option value="6">Bintik Merah</option>
                  @elseif (strcmp($kesehatan->k_kulit,"Tidak Ada Bercak"))
                  <option value="1">Bersih</option>
                  <option selected value="2">Tidak Ada Bercak</option>
                  <option value="3">Tidak Ada Luka Loreng</option>
                  <option value="4">Terdapat Bercak</option>
                  <option value="5">Luka Koreng</option>
                  <option value="6">Bintik Merah</option>
                  @elseif (strcmp($kesehatan->k_kulit,"Tidak Ada Luka Loreng"))
                  <option value="1">Bersih</option>
                  <option value="2">Tidak Ada Bercak</option>
                  <option selected value="3">Tidak Ada Luka Loreng</option>
                  <option value="4">Terdapat Bercak</option>
                  <option value="5">Luka Koreng</option>
                  <option value="6">Bintik Merah</option>
                  @elseif (strcmp($kesehatan->k_kulit,"Terdapat Bercak"))
                  <option value="1">Bersih</option>
                  <option value="2">Tidak Ada Bercak</option>
                  <option value="3">Tidak Ada Luka Loreng</option>
                  <option selected value="4">Terdapat Bercak</option>
                  <option value="5">Luka Koreng</option>
                  <option value="6">Bintik Merah</option>
                  @elseif (strcmp($kesehatan->k_kulit,"Luka Koreng"))
                  <option value="1">Bersih</option>
                  <option value="2">Tidak Ada Bercak</option>
                  <option value="3">Tidak Ada Luka Loreng</option>
                  <option value="4">Terdapat Bercak</option>
                  <option selected value="5">Luka Koreng</option>
                  <option value="6">Bintik Merah</option>
                  @elseif (strcmp($kesehatan->k_kulit,"Bintik Merah"))
                  <option value="1">Bersih</option>
                  <option value="2">Tidak Ada Bercak</option>
                  <option value="3">Tidak Ada Luka Loreng</option>
                  <option value="4">Terdapat Bercak</option>
              ...
              <div class="form-group">
                <label>Tinggi Badan (Cm)</label>
                <input type="text" name="tinggi_b" placeholder="Masukan Tinggi Badan" class="form-control" value="{{$kesehatan->tinggi_b}}" required>
              </div>
              <div class="form-group">
                <label>Berat Badan (Kg)</label>
                <input type="text" name="berat_b" placeholder="Masukan Tinggi Badan" class="form-control" value="{{$kesehatan->berat_b}}" required>
              </div>
              <br>
              <div class="form-group">
                <input type="submit" value="proses" class="btn btn-primary">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{route('kesehatan.update',$kesehatan->id)}}" method="POST">
              ...
              <input type="hidden" name="tgl_pengukuran" value="{{$awal->tgl_pengukuran}}">
