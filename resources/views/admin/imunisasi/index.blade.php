...
<section class="forms">
    <div class="container-fluid">
        ...
        <div class="siswa">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <form action="{{route('pilih.siswaimun')}}" method="POST">
                        @csrf
                        <div class="card">
                    ...
                    $semuasiswa = session('semuasiswa');
                            ...
                            <div class="card-body">
                                <div id="tes" class="form-group">
                                    ...
                                    <input list="listsiswa" class="form-control myClass" autocomplete="off"
                                        name="siswa">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="float:left">Data Imunisasi</h4>
                        <div style="float:right">
                            @if (isset($siswa))
                            <a href="{{route('imunisasi.add',$siswa->id)}}" class="btn btn-primary btn-sm">Tambah</a>
                            @else
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-sm">
                                ...
                                <tbody>
                                    <?php $x=1;?>
                                    @if (isset($siswa->imunisasi))
                                    @foreach ($siswa->imunisasi as $item)
                                    <tr>
                                        <th scope="row">{{$x++}}</th>
                                        <td>{{date("d-m-Y", strtotime($item->tgl_imunisasi))}}</td>
                                        <td>
                                            <a href="{{route('imunisasi.destroy',$item->id)}}"
...
<script>
    $(document).ready(function () {
        ...
        $('#submit').click(function () {
            ...
            var ubah = $('#tes').find('.myClass').val($('#listsiswa [value="' + value + '"]').data(
                'value'));
