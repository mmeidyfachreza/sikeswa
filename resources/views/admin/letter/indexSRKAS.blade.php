              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="regio1" class="form-control" id="" cols="30"
                                rows="3">{{old('regio1')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Regio poin 2:</label>
                            <textarea name="regio2" class="form-control" id="" cols="30"
                                rows="3">{{old('regio2')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Regio poin 3:</label>
                            <textarea name="regio3" class="form-control" id="" cols="30"
                                rows="3">{{old('regio3')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Regio poin 4:</label>
                            <textarea name="regio4" class="form-control" id="" cols="30"
                                rows="3">{{old('regio4')}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Regio poin 5:</label>
                            <textarea name="regio5" class="form-control" id="" cols="30"
