...
<section class="forms">
    <div class="container-fluid">
        ...
        @endif
        <form action="{{route('rekammedik.store',$siswa->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="date" name="tgl_pemeriksaan" placeholder="Masukan Nama Lengkap"
                                            class="form-control" value="{{Carbon\Carbon::today()->format('Y-m-d')}}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Alergi makanan tertentu</b>
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="alergi_makan2" type="radio" value="tidak" checked=""
                                                    name="alergi_makan" class="form-control-custom radio-custom">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="ket_alergi_makan" placeholder="Masukan alergi"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Alergi obat tertentu</b>
                                            <br><small class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="alergi_obat2" type="radio" value="tidak" checked=""
                                                    name="alergi_obat" class="form-control-custom radio-custom">
                                    ...
                                    <div class="form-group">
                                        <label>Jika ya sebutkan</label>
                                        <textarea name="ket_alergi_obat" placeholder="Masukan alergi"
                                            class="form-control" id="" cols="30"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Pernah mengalami cedera serius
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="cedera_serius2" type="radio" value="tidak" checked=""
                                                    name="cedera_serius" class="form-control-custom radio-custom">
                                    ...
                                    <div class="form-group">
                                        <label>Jika ya sebutkan</label>
                                        <textarea name="ket_cedera_serius" placeholder="Masukan alergi"
                                            class="form-control" id="" cols="30"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Riwayat kejang
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Riwayat Pingsan</b><br><small
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="pingsan2" type="radio" value="tidak" checked=""
                                                    name="pingsan" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Riwayat transfusi darah berulang
                                            </b><br><small class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                                <input id="transfusi_darah1" type="radio" value="ya"
                                                    name="transfusi_darah" class="form-control-custom radio-custom">
                                                <label for="transfusi_darah1">Ya</label>
                                            </div>
                                            <div class="i-checks">
                                                <input id="transfusi_darah2" type="radio" value="tidak" checked=""
                                                    name="transfusi_darah" class="form-control-custom radio-custom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Riwayat kelainan bawaan yang
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="kelainan2" type="radio" value="tidak" checked=""
                                                    name="kelainan" class="form-control-custom radio-custom">
                                    ...
                                    <div class="form-group">
                                        <label>Jika ya sebutkan</label>
                                        <textarea name="ket_kelainan" placeholder="Masukan kelainan"
                                            class="form-control" id="" cols="30"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Riwayat penyakit
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="lainnya2" type="radio" value="tidak" checked=""
                                                    name="lainnya" class="form-control-custom radio-custom">
                                    ...
                                    <div class="form-group">
                                        <label>Jika ya sebutkan</label>
                                        <textarea name="ket_lainnya" placeholder="Masukan penyakit" class="form-control"
                                            id="" cols="30" rows="2">{{old('ket_lainnya')}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Memiliki catatan imunisasi</b>
                                            <br><small class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="imunisasi2" type="radio" value="tidak" checked=""
                                                    name="imunisasi" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Saat bayi mendapat imunisasi </b>
                                            <br><small class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                                <input id="imunisasi_bayi1" type="radio" value="ya"
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Pada SD kelas 1 mendapat
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="imun_sd_12" type="radio" value="tidak" checked=""
                                                    name="imun_sd_1" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Pada SD kelas 2 mendapat
                                                imunisasi</b><br><small class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="imun_sd_22" type="radio" value="tidak" checked=""
                                                    name="imun_sd_2" class="form-control-custom radio-custom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Pada SD kelas 3 mendapat
                                                imunisasi</b><br><small class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="imun_sd_32" type="radio" value="tidak" checked=""
                                                    name="imun_sd_3" class="form-control-custom radio-custom">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Sarapan</b> <br><small
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="sarapan2" type="radio" value="tidak" checked=""
                                                    name="sarapan" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Jajan</b> <br><small
                                                class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Resiko merokok</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="res_merokok2" type="radio" value="tidak" checked=""
                                                    name="res_merokok" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Resiko minum minuman
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="res_alkohol2" type="radio" value="tidak" checked=""
                                                    name="res_alkohol" class="form-control-custom radio-custom">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Tuberkolosis (TBC)
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Diabetes Melitus</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Hepatitis/Sakit
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="hepatitis2" type="radio" value="tidak" checked=""
                                                    name="hepatitis" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Asma/Bengek</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Penyakit jantung</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="jantung2" type="radio" value="tidak" checked=""
                                                    name="jantung" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Stroke/lumpuh</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Obesitas/gemuk
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <div class="i-checks">
                                                <input id="obesitas2" type="radio" value="tidak" checked=""
                                                    name="obesitas" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Tekanan darah tinggi</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Kanker/tumor ganas</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Anamemia</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="anamemia2" type="radio" value="tidak" checked=""
                                                    name="anamemia" class="form-control-custom radio-custom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Thalasemia</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="thalasemia2" type="radio" value="tidak" checked=""
                                                    name="thalasemia" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Hemofilia</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="hemofilia2" type="radio" value="tidak" checked=""
                                                    name="hemofilia" class="form-control-custom radio-custom">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Gangguan pubertas</b> <br><small
                                                class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="pubertas2" type="radio" value="tidak" checked=""
                                                    name="pubertas" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Gangguan menstruasi</b> <br><small
                                                class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="menstruasi2" type="radio" value="tidak" checked=""
                                                    name="menstruasi" class="form-control-custom radio-custom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Resiko IMS</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Gejala Emosional</b> <br><small
                                                class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="gej_emosi2" type="radio" value="tidak" checked=""
                                                    name="gej_emosi" class="form-control-custom radio-custom">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Dominasi O</b> <br><small
                                                class="text-primary"> </small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="mas_perilaku2" type="radio" value="tidak" checked=""
                                                    name="mas_perilaku" class="form-control-custom radio-custom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Hiperaktifitas</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                                <input id="hiperaktifitas1" type="radio" value="ya"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Masalah Teman Sebaya</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
                                            ...
                                            <div class="i-checks">
                                                <input id="mas_tmnsbya2" type="radio" value="tidak" checked=""
                                                    name="mas_tmnsbya" class="form-control-custom radio-custom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        <label class="col-sm-5 form-control-label"><b>Perilaku prososial</b><br><small
                                                class="text-primary"><b></b></small></label>
                                        <div class="col-sm-7">
                                            <div class="i-checks">
